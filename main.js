...
`);
  ...
  inputs.keydown(function (event) {
    ...
    if (isEmailField && !isEmailValid) {
      ...
      if (aceImg.length) aceImg.attr("src", "img/qrto.png");
      return;
    }
      ...
      input.addEventListener("keydown", function (event) {
        ...
        if (aceImg) {
          if (colorRadio?.checked && imageCheckbox?.checked) {
            aceImg.src = "img/cardcheck2.png";
          } else if (colorRadio?.checked) {
            aceImg.src = "img/cardcheck1.png";
          } else if (imageCheckbox?.checked) {
            aceImg.src = "img/cardcheck3.png";
          } else {
            aceImg.src = "img/qrVcard.png";
          }
        }
      });
    });
      ...
      if (!value) {
        ...
        if (aceImg.length) {
          if (colorRadio.prop("checked") && imageCheckbox.prop("checked")) {
            ...
            aceImg.attr("src", "img/urlchec1.png");
          } else if (imageCheckbox.prop("checked")) {
            aceImg.attr("src", "img/urlchec3.png");
          } else {
            aceImg.attr("src", "img/qr to đen.png ");
  ...
  item.addEventListener("click", function () {
    ...
    if (imageCheckbox && imageCheckbox.checked) {
      ...
      if (currentSrc.includes("3mauso02.png")) {
        aceImg.setAttribute("src", "img/3mauso01.png");
      } else {
        aceImg.setAttribute("src", "img/3mauso02.png");
      }
    } else if (colorRadio && colorRadio.checked) {
      const currentSrc = aceImg.getAttribute("src");
      if (currentSrc.includes("prsection1.png")) {
        aceImg.setAttribute("src", "img/prsection2.png");
      } else {
        aceImg.setAttribute("src", "img/prsection1.png");
      }
    } else if (gradiention === "Linear gradient") {
      aceImg.src = "img/b01.png";
    }
  ...
  designimage1.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/a01.png";
      } else if (colorRadio && colorRadio.checked) {
        aceImg.src = "img/prsection2.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/1a1.png";
      } else {
        aceImg.src = "img/body1.png";
      }
    }
  });
  designimage2.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/a02.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/1a2.png";
      } else if (colorRadio && colorRadio.checked) {
        aceImg.src = "img/greenbody2.png";
      } else {
        aceImg.src = "img/body2.png";
      }
    }
  });
  designimage3.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/a03.png";
      } else if (colorRadio && colorRadio.checked) {
        aceImg.src = "img/greenbody3.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/1a3.png";
      } else {
        aceImg.src = "img/body3.png";
      }
    }
  });
});
  ...
  designimage1.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/greenbody4.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/c01.png";
      } else {
        aceImg.src = "img/body43.png";
      }
    }
  });
  designimage2.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/b02.png";
      } else if (colorRadio && colorRadio.checked) {
        aceImg.src = "img/greenbody5.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/c02.png";
      } else {
        aceImg.src = "img/body5.png";
      }
    }
  });
  designimage3.addEventListener("click", function () {
    ...
    if (aceImg) {
      if (
        ...
        aceImg.src = "img/b03.png";
      } else if (colorRadio && colorRadio.checked) {
        aceImg.src = "img/greenbody6.png";
      } else if (imageCheckbox && imageCheckbox.checked) {
        aceImg.src = "img/c03.png";
      } else {
        aceImg.src = "img/body6.png";
      }
    }
  });
});
